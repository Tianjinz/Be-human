    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float movementSpeed = _Time * 2;


                // UpperUV
                float upperUV = i.worldPos.xz / i.worldPos.y;
                ...
                //First Noise
                vector  randomNoise1 = Noise(i.worldPos / _CellSize);
                
                randomNoise1 = sampleLayeredNoise(randomNoise1) + 0.5;
                float dist = abs(randomNoise1 - i.worldPos);
